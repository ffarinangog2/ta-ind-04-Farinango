...
es min\'usculo; Yu et al. documentan precisamente que la operaci\'on de
...
pandas, cuyo tiempo de arranque es despreciable frente al tama\~no del
conjunto de datos~\cite{zaharia2016}.
\item \textbf{Ausencia de agregaci\'on parcial efectiva a esta cardinalidad.}
Con solo 40 claves de salida, la etapa de reducci\'on posterior al shuffle es
casi instant\'anea; todo el tiempo de la transformaci\'on distribuida se
concentra en mover datos, no en calcularlos, de modo que a\~nadir executors
divide el trabajo de shuffle entre m\'as unidades sin reducir el volumen
