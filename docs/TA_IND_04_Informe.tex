...
Se emplearon dos herramientas de inteligencia artificial generativa como
apoyo puntual en la elaboraci\'on de este informe, cuyo contenido t\'ecnico,
an\'alisis e interpretaci\'on son de autor\'ia y responsabilidad del
estudiante. \textbf{Claude (Anthropic)} se us\'o para: corregir ortograf\'ia,
tildes y redacci\'on en espa\~ol t\'ecnico; ordenar la estructura del
documento conforme a las diez secciones exigidas por la gu\'ia; verificar de
forma independiente los c\'alculos num\'ericos ya resueltos por el estudiante
(sustituci\'on en las ecuaciones de Amdahl, Karp-Flatt, eficiencia y umbral de
rentabilidad); resolver dudas puntuales sobre temas previamente
desconocidos para el estudiante, en particular la sintaxis de \LaTeX{} para
entornos de ecuaci\'on numerados, tablas \texttt{booktabs} y el paquete
\texttt{siunitx}, as\'i como la construcci\'on del diagrama en TikZ de la
Fig.~\ref{fig:arquitectura}; y ayudar a localizar y verificar el DOI de las
referencias bibliogr\'aficas citadas. \textbf{Codex (OpenAI)} se us\'o
\'unicamente para ejecutar, sobre el cl\'uster Standalone propio, el
protocolo de medici\'on de T2 con $N=1$ y $N=2$ executors ya definido y
utilizado por el equipo para las dem\'as configuraciones, sin modificar el
protocolo ni el c\'odigo de las transformaciones existentes. Se declara
adem\'as que la medici\'on de T2 con $N=1$ y $N=2$ no exist\'ia en el commit
original de PE-U4 --la gu\'ia grupal solo exig\'ia ese escalado para T3-- y
fue generada expresamente para este informe individual, incorpor\'andose al
repositorio grupal en el commit \texttt{bbe19c8} para preservar la
